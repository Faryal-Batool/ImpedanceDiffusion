# Module: Shared coordinate, filesystem, and indoor-world conversion helpers.

from PIL import Image
import numpy as np

# Class: Compatibility wrapper exposing indoor coordinate utilities as static methods.
class indoor_VLA_utils():

    # Function: Estimate image footprint and pixel-to-meter ratios from camera height and FOV.
    def calculate_real_world_size(image_path, camera_height, diagonal_fov, aspect_ratio=(16,9)):
    ...
    # Function: Convert percent image coordinates into Cartesian world coordinates.
    def process_coordinates(coordinates, diagonal_fov_degrees, altitude, image_metrics):
        """
